...
-- Which customer use a discount but still spent more than the average purchase amount?
...
-- Q5: Do subscibed customer spend more? Compare average spend and total revenue between subscrbers and non-subscribers:
select subscription_status, count(customer_id),
 ...
 -- Q6: Which 5 product have the highest percnetage of purchase with discount applied?
